# (Borrowed from Marcel Molina's aws-s3 gem.)
...
# For example:
#
# A fixture in <tt>story.yml</tt> named <tt>story_with_byline</tt> with value <tt><foo>hi!</foo></tt>
# would be made available like so:
#
#   Fixtures::Client.bad_api_key_response
#   => "<foo>bad!</foo>"
#   
...
#   => ["bad_api_key_response", "npr_system_error", "deactivated_api_key_res"]
#
require 'yaml'
